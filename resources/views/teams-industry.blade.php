    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        ...
        <div class="card bg-base-200 shadow-sm border-base-300 border-1">
          <div class="card-body">
            <h3 class="card-title text-2xl">Tech Company A</h3>
            <p class="text-base-content/70">Software Development Team</p>
            <div class="card-actions justify-end mt-4">
              <div class="badge badge-secondary">Industry</div>
            </div>
          </div>
        </div>
        ...
        <div class="card bg-base-200 shadow-sm border-base-300 border-1">
          <div class="card-body">
            <h3 class="card-title text-2xl">Corporate B</h3>
            <p class="text-base-content/70">Engineering Division</p>
            <div class="card-actions justify-end mt-4">
              <div class="badge badge-secondary">Industry</div>
            </div>
          </div>
        ...
        <div class="card bg-base-200 shadow-sm border-base-300 border-1">
          <div class="card-body">
            <h3 class="card-title text-2xl">Enterprise C</h3>
            <p class="text-base-content/70">IT Department</p>
            <div class="card-actions justify-end mt-4">
              <div class="badge badge-secondary">Industry</div>
            </div>
          </div>
